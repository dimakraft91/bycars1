...
const brandsSliderInit = () => {
  if (!brandsSlider) {
    brandsSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".brands", {
      slidesPerView: "auto",
      spaceBetween: 15,
      speed: 600
    });
...
const initOfferCarsSlider = () => {
  ...
  if (!offerCarsSlider) {
    offerCarsSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".offers-slider", {
      slidesPerView: "auto",
      spaceBetween: 30,
      loop: true,
      speed: 600,
  ...
  if (!catalogCarsSlider) {
    catalogCarsSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".catalog-slider", {
      slidesPerView: "auto",
      spaceBetween: 30,
      loop: true,
      speed: 600,
...
const feedbackSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".feedback-slider", {
  slidesPerView: 1,
  spaceBetween: 30,
  loop: true,
  pagination: {
...
window.addEventListener("resize", () => (0,_functions_header_height__WEBPACK_IMPORTED_MODULE_4__.getHeaderHeight)());
})();
